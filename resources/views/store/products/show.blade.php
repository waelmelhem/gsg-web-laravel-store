                ...
                <div class="row">
                    <div class="col-lg-10 col-md-12 col-lg-offset-1">
                        <div class="ps-product__thumbnail">
                            <div class="ps-product__preview">
                                <div class="ps-product__variants">
                                    ...
                                    <div class="item"><img  src="{{asset('assest/store/images/shoe-detail/2.jpg')}}" alt=""></div>
                                    <div class="item"><img  src="{{asset('assest/store/images/shoe-detail/3.jpg')}}" alt=""></div>
                                    <div class="item"><img  src="{{asset('assest/store/images/shoe-detail/3.jpg')}}" alt=""></div>
                                    <div class="item"><img  src="{{asset('assest/store/images/shoe-detail/3.jpg')}}" alt=""></div>
                            ...
                            <div class="ps-product__image">
                                <div class="item"><img class="zoom"  src="{{$product->image_url}}"
                                        alt="" data-zoom-image="{{$product->image_url}}"></div>
                                <div class="item"><img class="zoom"  src="{{asset('assest/store/images/shoe-detail/2.jpg')}}"
                                        alt="" data-zoom-image="images/shoe-detail/2.jpg')}}"></div>
                                <div class="item"><img class="zoom"  src="{{asset('assest/store/images/shoe-detail/3.jpg')}}"
                        ...
                        <div class="ps-product__thumbnail--mobile">
                            ...
                            <div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true"
                                ...
                                data-owl-item-lg="3" data-owl-duration="1000" data-owl-mousedrag="on"><img
                                     src="{{$product->image_url}}" alt=""><img  src="{{asset('assest/store/images/shoe-detail/2.jpg')}}"
                                    alt=""><img  src="{{asset('assest/store/images/shoe-detail/3.jpg')}}" alt=""></div>
                        </div>
                        <div class="ps-product__info">
                            ...
                            <h1>{{$product->name}}</h1>
                            <p class="ps-product__category"><a href="{{route('products',$category)}}">{{$product->category->name}}</a></p>
                            <h3 class="ps-product__price">{{Money::format($product->price)}}<del>{{Money::format($product->compare_price)}}</del></h3>
                            ...
                            <div class="ps-product__block ps-product__style">
                                ...
                                <ul>
                                    <li><a href="product-detail.html"><img  src="{{asset('assest/store/images/shoe/sidebar/1.jpg')}}" alt=""></a>
                                    </li>
                                    <li><a href="product-detail.html"><img  src="{{asset('assest/store/images/shoe/sidebar/2.jpg')}}" alt=""></a>
                                    </li>
                                    <li><a href="product-detail.html"><img  src="{{asset('assest/store/images/shoe/sidebar/3.jpg')}}" alt=""></a>
                                    </li>
                                    <li><a href="product-detail.html"><img  src="{{asset('assest/store/images/shoe/sidebar/2.jpg')}}" alt=""></a>
                                    </li>
                                </ul>
                        ...
                        <div class="tab-content mb-60">
                            ...
                            <div class="tab-pane" role="tabpanel" id="tab_02">
                                ...
                                <div class="ps-review">
                                    <div class="ps-review__thumbnail"><img  src="{{asset('assest/store/images/user/1.jpg')}}" alt=""></div>
                    ...
                    <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true"
                            ...
                            <div class="ps-shoe">
                                <div class="ps-shoe__thumbnail">
                                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                        href="#"><i class="ps-icon-heart"></i></a><img  src="{{asset('assest/store/images/shoe/1.jpg')}}"
                                        alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal"><img  src="{{asset('assest/store/images/shoe/2.jpg')}}" alt=""><img
                                                 src="{{asset('assest/store/images/shoe/3.jpg')}}" alt=""><img  src="{{asset('assest/store/images/shoe/4.jpg')}}" alt=""><img
                                ...
                                <div class="ps-shoe__thumbnail">
                                    ...
                                    <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a
                                        class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img
                                         src="{{asset('assest/store/images/shoe/2.jpg')}}" alt=""><a class="ps-shoe__overlay"
                        ...
                        <div class="ps-shoes--carousel">
                            <div class="ps-shoe">
                                <div class="ps-shoe__thumbnail">
                                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                        href="#"><i class="ps-icon-heart"></i></a><img  src="{{asset('assest/store/images/shoe/3.jpg')}}"
                                        alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                        ...
                        <div class="ps-shoes--carousel">
                            <div class="ps-shoe">
                                <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                                            class="ps-icon-heart"></i></a><img  src="{{asset('assest/store/images/shoe/4.jpg')}}" alt=""><a
                        ...
                        <div class="ps-shoes--carousel">
                            <div class="ps-shoe">
                                <div class="ps-shoe__thumbnail">
                                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                        href="#"><i class="ps-icon-heart"></i></a><img  src="{{asset('assest/store/images/shoe/5.jpg')}}"
                                        alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                        ...
                        <div class="ps-shoes--carousel">
                            <div class="ps-shoe">
                                <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                                            class="ps-icon-heart"></i></a><img  src="{{asset('assest/store/images/shoe/6.jpg')}}" alt=""><a
                                        class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">

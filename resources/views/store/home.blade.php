<x-store-layout title="Home">
            ...
            <ul>
                <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default"
                    data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg"
                        src="{{asset('assest/store/images/slider/3.jpg')}}')}}" alt="" data-bgposition="center center" data-bgfit="cover"
                ...
                <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random"
                    data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img
                        class="rev-slidebg" src="{{asset('assest/store/images/slider/2.jpg')}}" alt="" data-bgposition="center center"
                    ...
                    <div class="tp-caption ps-banner__description" id="layer2-14" data-x="['left','left','left','left']"
                        ...
                        data-voffset="['120','140','200','200']" data-type="text" data-responsive_offset="on"
                        data-textAlign="['center','center','center','center']"
                        data-frames="[{&quot;delay&q uot;:1500,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;x:50px;opacity:0;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power3.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:300,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;x:50px;opacity:0;&quot;,&quot;ease&quot;:&quot;Power3.easeInOut&quot;}]">Purchase
                        Now<i class="ps-icon-next"></i></a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="ps-product--hotdeal reverse">
                            <div class="ps-product__thumbnail"><a class="ps-product__overlay"
                                    href="product-detail.html"></a><img src="{{asset('assest/store/images/access/5.jpg')}}" alt=""></div>
                            <div class="ps-product__content"><a class="ps-product__title"
                                    href="product-detail.html">Slim Fit Men Sport Hoodie</a>
                                ...
                                </ul><a class="ps-btn" href="cart.html">Order Today<i
                                        class="ps-icon-next"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 "><a class="ps-offer mb-30"
                            href="product-detail.html"><img src="{{asset('assest/store/images/offer/home-3-1.jpg')}}" alt=""></a><a
                            class="ps-offer" href="product-detail.html"><img src="{{asset('assest/store/images/offer/home-3-3.jpg')}}"
                                alt=""></a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 "><a class="ps-offer"
                            href="product-detail.html"><img src="{{asset('assest/store/images/offer/home-3-2.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ps-features pt-80 pb-80 bg--cover" data-background="{{asset('assest/store/images/background/parallax.jpg')}}">
        <div class="ps-container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ">
                    <div class="ps-iconbox ps-iconbox--inverse">
                        ...
                        <div class="ps-iconbox__content">
                            <p>Want to track a package? Find tracking information and order details from Your Orders.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ">
                    <div class="ps-iconbox ps-iconbox--inverse">
                        ...
                        <div class="ps-iconbox__content">
                            <p>You may return most new, unopened items sold within 30 days of delivery for a full
                                refund.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="ps-section__content">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="ps-product--hotdeal reverse">
                            <div class="ps-product__thumbnail"><a class="ps-product__overlay"
                                    href="product-detail.html"></a><img src="{{asset('assest/store/images/access/4.jpg')}}" alt=""></div>
                            <div class="ps-product__content"><a class="ps-product__title text-uppercase"
                                    href="product-detail.html">Jordan pro andre hat</a>
                                <p class="ps-product__price">Only: <span>£178</span></p>
                                <div class="ps-product__status">
                                    <div class="sold">Already sold: <span>10</span></div>
                                    <div class="avaiable">Avaiable: <span>30</span></div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="ps-product--hotdeal reverse">
                            <div class="ps-product__thumbnail"><a class="ps-product__overlay"
                                    href="product-detail.html"></a><img src="{{asset('assest/store/images/access/1.jpg')}}" alt=""></div>
                            <div class="ps-product__content"><a class="ps-product__title text-uppercase"
                                    href="product-detail.html">brasilia small bag</a>
                                <p class="ps-product__price">Only: <span>£178</span></p>
                                <div class="ps-product__status">
                                    <div class="sold">Already sold: <span>10</span></div>
                                    <div class="avaiable">Avaiable: <span>30</span></div>
    ...
    <div class="ps-home-testimonial bg--parallax pb-80" data-background="{{asset('assest/store/images/background/parallax.jpg')}}">
        <div class="container">
            <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000"
                ...
                <div class="ps-testimonial">
                    <div class="ps-testimonial__thumbnail"><img src="{{asset('assest/store/images/testimonial/1.jpg')}}" alt=""><i
                ...
                <div class="ps-testimonial">
                    <div class="ps-testimonial__thumbnail"><img src="{{asset('assest/store/images/testimonial/2.jpg')}}" alt=""><i
                            class="fa fa-quote-left"></i></div>
                    <header>
                        <select class="ps-rating">
                            <option value="1">1</option>
                ...
                <div class="ps-testimonial">
                    <div class="ps-testimonial__thumbnail"><img src="{{asset('assest/store/images/testimonial/3.jpg')}}" alt=""><i
                            class="fa fa-quote-left"></i></div>
                    <header>
                        <select class="ps-rating">
                            <option value="1">1</option>
            ...
            <div class="ps-section__content">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay"
                                    href="blog-detail.html"></a><img src="{{asset('assest/store/images/blog/1.jpg')}}" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay"
                                    href="blog-detail.html"></a><img src="{{asset('assest/store/images/blog/2.jpg')}}" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay"
                                    href="blog-detail.html"></a><img src="{{asset('assest/store/images/blog/3.jpg')}}" alt=""></div>
    ...
    <div class="ps-home-partner">
        <div class="ps-container">
            <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000"
                data-owl-gap="40" data-owl-nav="false" data-owl-dots="false" data-owl-item="6" data-owl-item-xs="2"
                data-owl-item-sm="4" data-owl-item-md="5" data-owl-item-lg="6" data-owl-duration="1000"
                data-owl-mousedrag="on"><a href="#"><img src="{{asset('assest/store/images/partner/1.png')}}" alt=""></a><a href="#"><img
                        src="{{asset('assest/store/images/partner/2.png')}}" alt=""></a><a href="#"><img src="{{asset('assest/store/images/partner/3.png')}}" alt=""></a><a
                    href="#"><img src="{{asset('assest/store/images/partner/4.png')}}" alt=""></a><a href="#"><img src="{{asset('assest/store/images/partner/5.png')}}"
                        alt=""></a><a href="#"><img src="{{asset('assest/store/images/partner/6.png')}}" alt=""></a><a href="#"><img
                        src="{{asset('assest/store/images/partner/7.png')}}" alt=""></a><a href="#"><img src="{{asset('assest/store/images/partner/8.png')}}" alt=""></a>
            </div>
        </div>
    </div>
</x-store-layout>
